  ...
  _createClass(Difference, [{
    ...
    value: function hideItems() {
      this.oldOfficer.querySelectorAll(this.items).forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
          // приховуємо всі елементи, крім останнього 
    ...
    value: function bindTriggers() {
      ...
      var n = 0;
      this.oldOfficer.querySelector('.plus__content').addEventListener('click', function () {
        _this.oldOfficer.querySelectorAll(_this.items)[n].style.display = 'flex';
        n++;

        if (n > 2) {
          _this.oldOfficer.querySelectorAll(_this.items)[n].style.display = 'flex';
          _this.oldOfficer.querySelectorAll(_this.items)[_this.oldOfficer.querySelectorAll(_this.items).length - 1].style.display = 'none';
        }
      });
    }
  }, {
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      // визначає куди рухається слайдер. Якщо n +1 - вперед, -1 - назад
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass, animate, autoPlay, paused) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function decorizeSlides() {
      ...
      // додати клас активності першому слайду 
      this.slides.forEach(function (slide) {
        slide.classList.remove(_this.activeClass);

        if (_this.animate) {
          // якщо animate передано в main, бо не всім слайдерам це треба
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        ...
        var active = _this2.slides[_this2.slides.length - 1]; // останній слайд стає перед першим  
